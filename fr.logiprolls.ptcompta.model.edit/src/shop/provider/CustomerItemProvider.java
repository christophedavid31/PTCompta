...
/**
 * This is the item provider adapter for a {@link shop.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShopPackage.Literals.CUSTOMER__SALES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPaymentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_payments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_payments_feature", "_UI_Customer_type"),
				 ShopPackage.Literals.CUSTOMER__PAYMENTS,
				 true,
				 false,
				 true,
				 null,
