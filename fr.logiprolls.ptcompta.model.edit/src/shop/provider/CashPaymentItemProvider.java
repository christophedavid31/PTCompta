...
/**
 * This is the item provider adapter for a {@link shop.CashPayment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CashPaymentItemProvider 
	 ...
	 * @generated
	 */
	public CashPaymentItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCustomerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Payment_customer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Payment_customer_feature", "_UI_Payment_type"),
				 ShopPackage.Literals.PAYMENT__CUSTOMER,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CashPayment"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_CashPayment_type") + " " + label;
	}
