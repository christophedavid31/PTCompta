...
/**
 * This is the item provider adapter for a {@link fr.logiprolls.ptcompta.shop.MPayment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PaymentItemProvider 
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Payment_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Payment_type_feature", "_UI_Payment_type"),
				 MShopPackage.Literals.PAYMENT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((MPayment)object).getDate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Payment_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MPayment.class)) {
