 ...
 * </p>
 * <ul>
 *   <li>{@link fr.logiprolls.ptcompta.shop.impl.ChequePaymentImpl#getDate <em>Date</em>}</li>
...
public class ChequePaymentImpl extends MinimalEObjectImpl.Container implements ChequePayment {
	 ...
	 */
	public Sale getSale() {
		if (eContainerFeatureID() != ShopPackage.CHEQUE_PAYMENT__SALE) return null;
	...
	public NotificationChain basicSetSale(Sale newSale, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSale, ShopPackage.CHEQUE_PAYMENT__SALE, msgs);
		return msgs;
	}
	...
	public void setSale(Sale newSale) {
		if (newSale != eInternalContainer() || (eContainerFeatureID() != ShopPackage.CHEQUE_PAYMENT__SALE && newSale != null)) {
