 ...
 * </p>
 * <ul>
 *   <li>{@link fr.logiprolls.ptcompta.shop.AccountBook#getBankOperations <em>Bank Operations</em>}</li>
 *   <li>{@link fr.logiprolls.ptcompta.shop.AccountBook#getCashFlow <em>Cash Flow</em>}</li>
 *   <li>{@link fr.logiprolls.ptcompta.shop.AccountBook#getShop <em>Shop</em>}</li>
 *   <li>{@link fr.logiprolls.ptcompta.shop.AccountBook#getPayments <em>Payments</em>}</li>
 * </ul>
 *
 * @see fr.logiprolls.ptcompta.shop.ShopPackage#getAccountBook()
 * @model
 * @generated
 */
public interface AccountBook extends EObject {
	 ...
	 * The list contents are of type {@link fr.logiprolls.ptcompta.shop.BankOperation}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.logiprolls.ptcompta.shop.ShopPackage#getAccountBook_BankOperations()
	 ...
	 * @see fr.logiprolls.ptcompta.shop.ShopPackage#getAccountBook_CashFlow()
	 * @model
	 * @generated
	 */
	float getCashFlow();
	...
	/**
	 * Sets the value of the '{@link fr.logiprolls.ptcompta.shop.AccountBook#getCashFlow <em>Cash Flow</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link fr.logiprolls.ptcompta.shop.Shop#getAccountBook <em>Account Book</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setShop(Shop)
	 * @see fr.logiprolls.ptcompta.shop.ShopPackage#getAccountBook_Shop()
	...
	/**
	 * Sets the value of the '{@link fr.logiprolls.ptcompta.shop.AccountBook#getShop <em>Shop</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.logiprolls.ptcompta.shop.ShopPackage#getAccountBook_Payments()
	 * @model
	 * @generated
	 */
