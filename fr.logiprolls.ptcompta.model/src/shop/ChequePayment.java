 ...
 * </p>
 * <ul>
 *   <li>{@link shop.ChequePayment#isDeposited <em>Deposited</em>}</li>
 * </ul>
 *
 * @see shop.ShopPackage#getChequePayment()
 * @model
 * @generated
 */
public interface ChequePayment extends Payment {
	 ...
	 * @see shop.ShopPackage#getChequePayment_Deposited()
	 * @model
	 * @generated
	 */
	boolean isDeposited();
	...
	/**
	 * Sets the value of the '{@link shop.ChequePayment#isDeposited <em>Deposited</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
