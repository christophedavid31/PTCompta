 ...
 * </p>
 * <ul>
 *   <li>{@link shop.impl.AccountBookImpl#getBankOperations <em>Bank Operations</em>}</li>
 *   <li>{@link shop.impl.AccountBookImpl#getCashFlow <em>Cash Flow</em>}</li>
 *   <li>{@link shop.impl.AccountBookImpl#getShop <em>Shop</em>}</li>
 *   <li>{@link shop.impl.AccountBookImpl#getPayments <em>Payments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccountBookImpl extends MinimalEObjectImpl.Container implements AccountBook {
	...
	public EList<Payment> getPayments() {
		if (payments == null) {
			payments = new EObjectContainmentEList<Payment>(Payment.class, this, ShopPackage.ACCOUNT_BOOK__PAYMENTS);
		}
		return payments;
	}
