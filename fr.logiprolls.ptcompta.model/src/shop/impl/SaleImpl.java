 ...
 *   <li>{@link shop.impl.SaleImpl#getEmployee <em>Employee</em>}</li>
...
public class SaleImpl extends MinimalEObjectImpl.Container implements Sale {
	...
	public void setCustomer(Customer newCustomer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShopPackage.SALE__CUSTOMER, oldCustomer, customer));
	}
	...
	public Employee getEmployee() {
		if (employee != null && employee.eIsProxy()) {
			...
			if (employee != oldEmployee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShopPackage.SALE__EMPLOYEE, oldEmployee, employee));
			}
		}
		return employee;
	}
	...
	public void setEmployee(Employee newEmployee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShopPackage.SALE__EMPLOYEE, oldEmployee, employee));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ShopPackage.SALE__EMPLOYEE:
