 ...
 * </p>
 * <ul>
 *   <li>{@link shop.impl.SaleImpl#getDate <em>Date</em>}</li>
 *   <li>{@link shop.impl.SaleImpl#getValue <em>Value</em>}</li>
 *   <li>{@link shop.impl.SaleImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link shop.impl.SaleImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link shop.impl.SaleImpl#getEmployees <em>Employees</em>}</li>
 *   <li>{@link shop.impl.SaleImpl#getPayments <em>Payments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SaleImpl extends MinimalEObjectImpl.Container implements Sale {
	...
	public EList<Payment> getPayments() {
		if (payments == null) {
			payments = new EObjectWithInverseResolvingEList<Payment>(Payment.class, this, ShopPackage.SALE__PAYMENTS, ShopPackage.PAYMENT__SALE);
		}
		return payments;
	}
